...
<div id="nav">
<ul>
  <li><a class="active" href="index.php"><font color="#e3e3e3">Home</font></a></li>
  <li class="styleit" style="display:<?php echo $text2 ?>"><a href="profile.php"><font color="#e3e3e3">profile</font></a></li>
  <li><a href="food_insert.php"><font color="#e3e3e3">insert_food</font></a></li>
 
   <li style="display:<?php echo $text2 ?>"><a href="action.php?op=logout"><font color="#e3e3e3">logout</font></a></li>
</ul>
